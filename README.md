...
[[arxiv](https://arxiv.org/abs/xx)] [[pdf](https://csdwren.github.io/papers/DIoU_aaai_camera.pdf)]
...
## Simulation Examples
We give three typical regression examples to analyze GIoU loss and our DIoU loss. 
...
Second, the anchor box is set at horizontal orientation. GIoU loss firstly broadens the right edge of prediction box, while the
